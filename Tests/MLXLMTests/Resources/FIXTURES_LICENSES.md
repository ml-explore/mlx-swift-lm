# Gemma 4 audio test fixtures - sources and licenses

All media used by the Gemma 4 audio integration tests, with provenance and
license. CC0/Public-Domain files need no attribution; CC-BY files are
attributed below.
