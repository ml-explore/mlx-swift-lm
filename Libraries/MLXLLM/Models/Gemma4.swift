...
//
//  Thin wrapper around Gemma4TextModel that handles the "gemma4" model_type
//  from HuggingFace configs (nested text_config) and strips VLM weight prefixes.
//  Based on Stefan Geens' approach from PR #185.
...
public struct Gemma4Configuration: Codable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
            ...
            Gemma4TextConfiguration.self, forKey: .textConfig)
        {
            ...
            self.textConfig.vocabularySize = self.vocabSize
        } else {
