    ...
    public enum MediaProcessing {
        ...
        public static func normalize(
            ...
            filter.biasVector = .init(
                x: -mean.0 / std.0, y: -mean.1 / std.1, z: -mean.2 / std.2, w: 0)
        ...
        public static func fitIn(_ size: CGSize, shortestEdge: Int) -> CGSize {
            ...
            return size.width <= size.height
                ? CGSize(width: newShort, height: newLong)
                : CGSize(width: newLong, height: newShort)
        }
        ...
        public static func padToSquare(_ image: CIImage, backgroundColor: CIColor = .black)
            -> CIImage
        {
